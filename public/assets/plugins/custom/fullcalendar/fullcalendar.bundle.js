...
var FullCalendar=function(e) {
  ...
  ,d=[],p=/acit|ex(?:s|g|n|p|$)|rph|grid|ows|mnc|ntw|ine[ch]|zoo|^ord|itera/i;
    function f(e,
  t) {
  ...
  o) {
    var a= {
    type:e,props:t,key:n,ref:r,__k:null,__:null,__b:0,__e:null,__d:void 0,__c:null,__h:null,constructor:void 0,__v:null==o?++i.__v:o,
  }
  ...
  ,o)).__v=o.__v+1,I(a,o,r,t.__n,void 0!==a.ownerSVGElement,null!=o.__h?[i]:null,n,null==i?E(o):i,o.__h),P(n,o),o.__e!=i&&b(o)));
  }
  ...
  l,
  u) {
    var p,f,h,v,y,b,S,w=r&&r.__k||d,D=w.length;
    for(n.__k=[],p=0;
    p<t.length;
    p++)if(null!=(v=n.__k[p]=null==(v=t[p])||"boolean"==typeof v?null:"string"==typeof v||"number"==typeof v||"bigint"==typeof v?g(null,
  v,
  null,
  null,
  v):Array.isArray(v)?g(m,
   {
    children:v;
  }
  ...
  I(e,v,h=h||c,o,i,a,s,l,u),y=v.__e,(f=v.ref)&&h.ref!=f&&(S||(S=[]),h.ref&&S.push(h.ref,null,v),S.push(f,v.__c||y,v)),null!=y?(null==b&&(b=y),"function"==typeof v.type&&null!=v.__k&&v.__k===h.__k?v.__d=l=T(v,l,e):l=C(e,v,h,w,y,l),u||"option"!==n.type?"function"==typeof n.type&&(n.__d=l):e.value=""):l&&h.__e==l&&l.parentNode!=e&&(l=E(h));
  }

  for(n.__e=b,p=D;
    p--;
    )null!=w[p]&&("function"==typeof n.type&&null!=w[p].__e&&w[p].__e==n.__d&&(n.__d=E(r,p+1)),A(w[p],w[p]));
    if(S)for(p=0;
    p<S.length;
    p++)H(S[p],S[++p],S[++p]);
  }
  ...
  n) {
    ...
    for(r=0;
    r<e.__k.length;
    r++)(o=e.__k[r])&&(o.__=e,t="function"==typeof o.type?T(o,t,n):C(n,o,o,e.__k,o.__e,t));
    return t;
  }
  ...
  ),e.l[t+i]=n,n?r||e.addEventListener(t,i?M:_,i):e.removeEventListener(t,i?M:_,i);
  ...
  l,
  u) {
    var c,d,p,h,v,g,E,b,S,w,T,x=t.type;
  ...
  n.__c?E=(d=t.__c=n.__c).__=d.__E:("prototype"in x&&x.prototype.render?t.__c=d=new x(b,
  w):(t.__c=d=new y(b,
  w),
  d.constructor=x,
  d.render=O),
  ...
  null!=x.getDerivedStateFromProps&&(d.__s==d.state&&(d.__s=f( {}

  ,d.__s)),f(d.__s,x.getDerivedStateFromProps(b,d.__s))),h=d.props,v=d.state,p)null==x.getDerivedStateFromProps&&null!=d.componentWillMount&&d.componentWillMount(),null!=d.componentDidMount&&d.__h.push(d.componentDidMount);
    else {
    if(null==x.getDerivedStateFromProps&&b!==h&&null!=d.componentWillReceiveProps&&d.componentWillReceiveProps(b,
  w),
  !d.__e&&null!=d.shouldComponentUpdate&&!1===d.shouldComponentUpdate(b,
  d.__s,
  w)||t.__v===n.__v) {
    d.props=b,
  d.state=d.__s,
  ...
  null!=d.componentWillUpdate&&d.componentWillUpdate(b,
  d.__s,
  w),
  ...
  ,r),d.getChildContext())),p||null==d.getSnapshotBeforeUpdate||(g=d.getSnapshotBeforeUpdate(h,v)),T=null!=c&&c.type===m&&null==c.key?c.props.children:c,D(e,Array.isArray(T)?T:[T],t,n,r,o,a,s,l,u),d.base=t.__e,t.__h=null,d.__h.length&&s.push(d),E&&(d.__E=d.__=null),d.__e=!1;
  }
  ...
  s) {
    ...
    y<i.length;
    y++)if((l=i[y])&&(l===e||(m?l.localName==m:3==l.nodeType))) {
    e=l,i[y]=null;
    break;
  }
  ...
  (e,g,v,o,s),p)t.__k=[];
    else if(y=t.props.children,D(e,Array.isArray(y)?y:[y],t,n,r,o&&"foreignObject"!==m,i,a,e.firstChild,s),null!=i)for(y=i.length;
    y--;
    )null!=i[y]&&h(i[y]);
  ...
  (r=e.ref)&&(r.current&&r.current!==e.__e||H(r,
  null,
  t)),
  ...
  ,n),this.props)),e&&f(n,e),null!=e&&this.__v&&(t&&this.__h.push(t),S(this));
  }
  ...
  ,y.prototype.render=m,a=[],s="function"==typeof Promise?Promise.prototype.then.bind(Promise.resolve()):setTimeout,w.__r=0,u=0;
    var U,W=[],z=i.__b,V=i.__r,F=i.diffed,B=i.__c,j=i.unmount;
    function G() {
  ...
  X.prototype.shouldComponentUpdate=function(e,
  t) {
  ...
  ,
  (ee.prototype=new y).__c=function(e,
  t) {
    var n=t.__c,r=this;
  ...
  "componentWillUpdate"].forEach((function(e) {
  ...
  e.prototype.refetch=function() {
    this.context.dispatch( {
    type:"FETCH_EVENT_SOURCES",sourceIds:[this.internalEventSource.sourceId],isRefetch:!0;
  }
  ...
  function we(e,
  t) {
    for(var n=e instanceof HTMLElement?[e]:e,r=[],o=0;
    o<n.length;
  ...
  t,
  n) {
    null==n?e.style[t]="":"number"==typeof n&&De.test(t)?e.style[t]=n+"px":e.style[t]=n;
  }
  ...
  function je(e) {
    ...
    t<o.length;
    t+=1)"string"==typeof(n=o[t])?r.push("-"===n.charAt(0)? {
  ...
  t,
  n) {
    return"function"==typeof e?e.apply(void 0,
  t):"string"==typeof e?t.reduce((function(e,
  t,
  n) {
  ...
  t) {
    var n=lt(e),r=lt(t);
    return {
    years:0,months:0,days:Math.round(ot(n,r)),milliseconds:t.valueOf()-r.valueOf()-(e.valueOf()-n.valueOf());
  }
  }
  ...
  r) {
    return {
    instanceId:Le(),defId:e,range:t,forcedStartTzo:null==n?null:n,forcedEndTzo:null==r?null:r;
  }
  }
  ...
  (e):"object"==typeof e&&e?Ht(e):"number"==typeof e?Ht(((n= {}
  ...
  o) {
    e=e.replace(Qt,
  ""),
  "short"===n.timeZoneName&&(e=function(e,
  t) {
    var n=!1;
    e=e.replace(en,
  (function() {
  ...
  (e,"UTC"===o.timeZone||null==t.timeZoneOffset?"UTC":jt(t.timeZoneOffset)));
    ...
    !1===r.meridiem?e=e.replace(Xt,
  "").trim():"narrow"===r.meridiem?e=e.replace(Xt,
  (function(e,
  t) {
    return t.toLocaleLowerCase();
  }

  )):"short"===r.meridiem?e=e.replace(Xt,
  (function(e,
  t) {
    return t.toLocaleLowerCase()+"m";
  }

  )):"lowercase"===r.meridiem&&(e=e.replace(Xt,
  (function(e) {
  ...
  r) {
    ...
    return {
    date:o,start:o,end:t?rn(t,n.calendarSystem):null,timeZone:n.timeZone,localeCodes:n.locale.codes,defaultSeparator:r||n.defaultSeparator;
  }
  }
  ...
  ,
  dn= {
    datesSet:yn,eventsSet:yn,eventAdd:yn,eventChange:yn,eventRemove:yn,windowResize:yn,eventClick:yn,eventMouseEnter:yn,eventMouseLeave:yn,select:yn,unselect:yn,loading:yn,_unmount:yn,_beforeprint:yn,_afterprint:yn,_noEventDrop:yn,_noEventResize:yn,_resize:yn,_scrollRequest:yn;
  }

  ,
  pn= {
    buttonText:yn,buttonHints:yn,views:yn,plugins:yn,initialEvents:yn,events:yn,eventSources:yn;
  }

  ,
  fn= {
    headerToolbar:hn,footerToolbar:hn,buttonText:hn,buttonHints:hn,buttonIcons:hn,dateIncrement:hn;
  }
  ...
  var vn= {
    type:String,component:yn,buttonText:String,buttonTextKey:String,dateProfileGeneratorClass:yn,usesMinMaxTime:Boolean,classNames:yn,content:yn,didMount:yn,willUnmount:yn;
  }
  ...
  var Cn= {
    display:String,editable:Boolean,startEditable:Boolean,durationEditable:Boolean,constraint:yn,overlap:yn,allow:yn,className:xn,classNames:xn,color:String,backgroundColor:String,borderColor:String,textColor:String;
  }
  ...
  (e.constraint,t);
    return {
    display:e.display||null,startEditable:null!=e.startEditable?e.startEditable:e.editable,durationEditable:null!=e.durationEditable?e.durationEditable:e.editable,constraints:null!=n?[n]:[],overlap:null!=e.overlap?e.overlap:null,allows:null!=e.allow?[e.allow]:[],backgroundColor:e.backgroundColor||e.color||"",borderColor:e.borderColor||e.color||"",textColor:e.textColor||"",classNames:(e.className||[]).concat(e.classNames||[]);
  }
  }
  ...
  ,
  Pn= {
    start:yn,end:yn,date:yn,allDay:Boolean;
  }
  ...
  Boolean(u.duration),
  n)).recurringDef= {
    typeId:u.typeId,typeData:u.typeData,duration:u.duration;
  }
  ...
  ,forcedStartTzo:o?o.forcedTzo:null,forcedEndTzo:i?i.forcedTzo:null;
  }
  }

  (a,l,n,r);
    return d? {
    def:c=Ln(a,s,t?t.sourceId:"",d.allDay,d.hasEnd,n),instance:mt(c.defId,d.range,d.forcedStartTzo,d.forcedEndTzo);
  }
  ...
  ,Cn),Nn),e.pluginHooks.eventRefiners);
  }
  ...
  ,l=0,u=a.pluginHooks.eventDefMemberAdders;
    l<u.length;
    l++) {
    var c=u[l];
    r(s,c(e));
  ...
  t) {
    ...
    return null!==t.start&&(n=null===n?t.start:new Date(Math.max(n.valueOf(),
  t.start.valueOf()))),
  null!=t.end&&(r=null===r?t.end:new Date(Math.min(r.valueOf(),
  t.end.valueOf()))),
  (null===n||null===r||n<r)&&(o= {
    start:n,end:r;
  }
  ...
  for(var d in e.instances) {
    var p=e.instances[d],f=u[(b=e.defs[p.defId]).defId],h=p.range,v=!b.allDay&&r?Wn(h,r):h,g=jn(v,n);
    ...
    def:b,ui:f,instance:p,range:g,isStart:v.start&&v.start.valueOf()===g.start.valueOf(),isEnd:v.end&&v.end.valueOf()===g.end.valueOf();
  }

  ));
  }

  for(var m in o)for(var y=0,E=Fn(o[m],n);
    y<E.length;
    y++) {
    var b,S=E[y];
    f=u[(b=a[m]).defId];
    s.push( {
    def:b,ui:f,instance:null,range:S,isStart:!1,isEnd:!1;
  }

  );
  }

  for(var c in i)for(var w=0,D=Fn(i[c],n);
    w<D.length;
    w++) {
    S=D[w];
    s.push( {
    def:e.defs[c],ui:u[c],instance:null,range:S,isStart:!1,isEnd:!1;
  }
  ...
  n),
   {
    id:n.publicId,start:i,end:a,duration:a-i,allDay:Number(n.allDay),_seg:e;
  }
  ...
  function rr(e,
  t) {
    for(var n=t.pluginHooks.isDraggableTransformers,r=e.eventRange,o=r.def,i=r.ui,a=i.startEditable,s=0,l=n;
    s<l.length;
    s++) {
    a=(0,l[s])(a,o,i,t);
  }
  ...
  g=y?h:g,
  c&&d.hasEnd?s.formatRange(v,
  g,
  t,
   {
    forcedStartTzo:i?null:p.forcedStartTzo,forcedEndTzo:a?null:p.forcedEndTzo;
  }
  ...
  n) {
    ...
    return {
    isPast:r.end<(n||t.start),isFuture:r.start>=(n||t.end),isToday:t&&Zn(t,r.start);
  }
  }
  ...
  s?Ae((function(e) {
   ...
   {
    el:e.target,event:new _r(t,r,o),jsEvent:e,view:t.viewApi;
  }
  ...
  var dr= {
    start:yn,end:yn,allDay:Boolean;
  }
  ...
  t) {
    ...
    return r( {
    range: {
    start:a?a.marker:null,end:s?s.marker:null;
  }
  ...
  t) {
    return Gn(e.range,
  t.range)&&e.allDay===t.allDay&&function(e,
  t) {
  ...
  ,n),o=Ln(r.refined,r.extra,"",e.allDay,!0,n);
    return {
    def:o,ui:er(o,t),instance:mt(o.defId,e.range),range:e.range,isStart:!0,isEnd:!0;
  }
  }
  ...
  ,a=0,s=t.pluginHooks.dateSpanTransforms;
    a<s.length;
    a++) {
    var l=s[a];
    r(i,l(e,t));
  ...
  o.datesDelta&&n.startEditable&&(u.range= {
    start:a.add(u.range.start,o.datesDelta),end:a.add(u.range.end,o.datesDelta);
  }

  ),
  o.startDelta&&n.durationEditable&&(u.range= {
    start:a.add(u.range.start,o.startDelta),end:u.range.end;
  }

  ),
  o.endDelta&&n.durationEditable&&(u.range= {
    start:u.range.start,end:a.add(u.range.end,o.endDelta);
  }

  ),
  l&&(u.range= {
    start:u.range.start,end:Er(t.allDay,u.range.start,i);
  }

  ),
  t.allDay&&(u.range= {
    start:lt(u.range.start),end:lt(u.range.end);
  }
  ...
  (),
  Tr= {
    id:String,defaultAllDay:Boolean,url:String,format:String,events:yn,eventDataTransform:yn,success:yn,failure:yn;
  }
  ...
  (i,t);
    if(s)return {
    _raw:e,isFetching:!1,latestFetchId:"",fetchRange:null,defaultAllDay:i.defaultAllDay,eventDataTransform:i.eventDataTransform,success:i.success,failure:i.failure,publicId:i.id||"",sourceId:Le(),sourceDefId:s.sourceDefId,meta:s.meta,ui:Rn(i,t),extendedProps:a;
  }
  }
  ...
  ,Cn),Tr),e.pluginHooks.eventSourceRefiners);
  }
  ...
  ,
  e.prototype.changeView=function(e,
  t) {
    var n=this;
    this.batchRendering((function() {
    if(n.unselect(),
  t)if(t.start&&t.end)n.dispatch( {
  ...
  e.prototype.today=function() {
    ...
    this.unselect(),
  this.dispatch( {
    type:"CHANGE_DATE",dateMarker:kr(e.calendarOptions.now,e.dateEnv);
  }
  ...
  ,
  e.prototype.formatIso=function(e,
  t) {
    var n=this.getCurrentData().dateEnv;
  ...
  var s=Hn(e,o,i,!1);
    ...
    type:"ADD_EVENTS",eventStore:bn(s);
  }
  ...
  revert:function() {
    t.dispatch( {
    type:"REMOVE_EVENTS",eventStore:Mr(e);
  }
  ...
  e.prototype.addEventSource=function(e) {
    ...
    type:"ADD_EVENT_SOURCES",sources:[e.internalEventSource];
  }

  ),e;
    var n=xr(e,t);
    return n?(this.dispatch( {
    type:"ADD_EVENT_SOURCES",sources:[n];
  }
  ...
  return e.prototype.setProp=function(e,
  t) {
    var n,r;
  ...
  ,
  e.prototype.setExtendedProp=function(e,
  t) {
    var n;
    this.mutate( {
    extendedProps:(n= {}
  ...
  ,
  e.prototype.setDates=function(e,
  t,
  n) {
    void 0===n&&(n= {}
  ...
  (o=c).years===i.years&&o.months===i.months&&o.days===i.days&&o.milliseconds===i.milliseconds?this.mutate( {
    datesDelta:c,standardProps:s;
  }

  ):this.mutate( {
    startDelta:c,endDelta:d,standardProps:s;
  }
  ...
  ,
  e.prototype.setAllDay=function(e,
  t) {
    void 0===t&&(t= {}
  ...
  e.prototype.formatRange=function(e) {
    ...
    return this._def.hasEnd?t.formatRange(n.range.start,
  n.range.end,
  r,
   {
  ...
  e.prototype.mutate=function(t) {
    ...
    if(n) {
    var r=this._def,o=this._context,i=o.getCurrentData().eventStore,a=Sn(i,n.instanceId);
    a=br(a,
   {
    "": {
  ...
  o.dispatch( {
    type:"MERGE_EVENTS",eventStore:a;
  }
  ...
  ,
  e.prototype.diffWholeYears=function(e,
  t) {
  ...
  ,
  e.prototype.diffWholeMonths=function(e,
  t) {
    var n=this.calendarSystem;
  ...
  ,
  e.prototype.greatestWholeUnit=function(e,
  t) {
  ...
  ,
  e.prototype.countDurationsBetween=function(e,
  t,
  n) {
    var r;
    return n.years&&null!==(r=this.diffWholeYears(e,
  t))?r/(Lt(n)/365):n.months&&null!==(r=this.diffWholeMonths(e,
  t))?r/function(e) {
    return Lt(e)/30;
  }
  ...
  e.prototype.computeWeekNumber=function(e) {
    return this.weekNumberFunc?this.weekNumberFunc(this.toDate(e)):function(e,
  t,
  n) {
  ...
  ,weekText:"W",weekTextLong:"Week",closeHint:"Close",timeHint:"Time",eventHint:"Event",allDayText:"all-day",moreLinkText:"more",noEventsText:"No events to display";
  }
  ...
  moreLinkHint:function(e) {
    ...
    function Vr(e) {
    for(var t=e.length>0?e[0].code:"en",
  n=Ur.concat(e),
  r= {
    en:zr;
  }
  ...
  function Fr(e,
  t) {
    return"object"!=typeof e||Array.isArray(e)?function(e,
  t) {
    var n=[].concat(e||[]),
  r=function(e,
  t) {
  ...
  function Kr(e) {
    return {
    left:(e.left+e.right)/2,top:(e.top+e.bottom)/2;
  }
  }
  ...
  i=this.splitIndividualUi(e.eventUiBases,
  r),
  a=this.splitEventStore(e.eventStore,
  r),
  ...
  ;
    for(var c in this.eventUiBuilders=St(n,
  (function(e,
  n) {
  ...
  ,
  e.prototype._splitEventStore=function(e,
  t) {
    var n=e.defs,
  r=e.instances,
  o= {}
  ...
  for(var l in r)for(var u=r[l],c=0,d=t[u.defId];
    c<d.length;
    c++) {
    var p;
  ...
  ,
  e.prototype._splitIndividualUi=function(e,
  t) {
    var n= {}
  ...
  ;
    if(e) {
    var n=this._splitEventStore(e.affectedEvents,
  this._getKeysForEventDefs(e.affectedEvents)),
  r=this._getKeysForEventDefs(e.mutatedEvents),
  o=this._splitEventStore(e.mutatedEvents,
  r),
  i=function(r) {
    t[r]||(t[r]= {
    affectedEvents:n[r]||eo,mutatedEvents:o[r]||eo,isEvent:e.isEvent;
  }
  ...
  r) {
    return {
    dow:e.getUTCDay(),isDisabled:Boolean(r&&!Zn(r.activeRange,e)),isOther:Boolean(r&&!Zn(r.currentRange,e)),isToday:Boolean(t&&Zn(t,e)),isPast:Boolean(n?e<n:!!t&&e<t.start),isFuture:Boolean(n?e>n:!!t&&e>=t.end);
  }
  }
  ...
  ;
    return r( {
    title:$e(a.navLinkHint,[l,u],l),"data-navlink":"";
  }
  ...
  r=parseInt(n.borderLeftWidth,
  10)||0,
  o=parseInt(n.borderRightWidth,
  10)||0,
  i=parseInt(n.borderTopWidth,
  10)||0,
  a=parseInt(n.borderBottomWidth,
  10)||0,
  s=fo(e),
  l=s.y-r-o,
  u= {
  ...
  ();
    if(To.prototype.classes= {}

  ,
  To.prototype.iconClasses= {}

  ,To.prototype.baseIconClass="",To.prototype.iconOverridePrefix="","undefined"==typeof FullCalendarVDom)throw new Error("Please import the top-level fullcalendar lib before attempting to import a plugin.");
  ...
  ,
  t.prototype.queryHit=function(e,
  t,
  n,
  r) {
    return null;
  ...
  return {
    contentKey:n,buildLifecycleFuncs:r;
  }
  }
  ...
  ,c),e.overrides),buttonTextOverride:p(o)||p(n)||e.overrides.buttonText,buttonTextDefault:p(i)||e.defaults.buttonText||p(cn)||e.type,buttonTitleOverride:f(o)||f(n)||e.overrides.buttonHint,buttonTitleDefault:f(i)||e.defaults.buttonHint||f(cn);
  }
  }
  ...
  o=this.buildCurrentRangeInfo(e,
  t),
  i=/^(year|month|week|day)$/.test(o.unit),
  a=this.buildRenderRange(this.trimHiddenDays(o.range),
  o.unit,
  i),
  s=a=this.trimHiddenDays(a),
  d.showNonCurrentDates||(s=jn(s,
  o.range)),
  s=jn(s=this.adjustActiveRange(s),
  r),
  l=qn(o.range,
  r),
   {
  ...
  ,
  e.prototype.buildCurrentRangeInfo=function(e,
  t) {
    var n,r=this.props,o=null,i=null,a=null;
    return r.duration?(o=r.duration,
  i=r.durationUnit,
  a=this.buildRangeFromDuration(e,
  t,
  o,
  i)):(n=this.props.dayCount)?(i="day",
  a=this.buildRangeFromDayCount(e,
  t,
  n)):(a=this.buildCustomVisibleRange(e))?i=r.dateEnv.greatestWholeUnit(a.start,
  a.end).unit:(i=zt(o=this.getFallbackDuration()).unit,
  a=this.buildRangeFromDuration(e,
  t,
  o,
  i)),
  ...
  ,
  e.prototype.buildRangeFromDuration=function(e,
  t,
  n,
  r) {
  ...
  ,
  e.prototype.buildRangeFromDayCount=function(e,
  t,
  n) {
  ...
  ,
  e.prototype.buildRenderRange=function(e,
  t,
  n) {
    return e;
  }
  ...
  e.prototype.buildDateIncrement=function(e) {
    ...
    return n||((t=this.props.dateAlignment)?Nt(1,
  t):e||Nt( {
    days:1;
  }
  ...
  ,
  e.prototype.skipHiddenDays=function(e,
  t,
  n) {
    for(void 0===t&&(t=1),void 0===n&&(n=!1);
  ...
  function(e,
  t) {
    var n=Cr(t),r=[].concat(e.eventSources||[]),o=[];
  ...
  o) {
    ...
    switch(t.type) {
    case"ADD_EVENT_SOURCES":return ci(e,t.sources,s,o);
    case"REMOVE_EVENT_SOURCE":return i=e,
  a=t.sourceId,
  bt(i,
  (function(e) {
    return e.sourceId!==a;
    ...
    case"FETCH_EVENT_SOURCES":return pi(e,t.sourceIds?wt(t.sourceIds):hi(e,o),s,t.isRefetch||!1,o);
    case"RECEIVE_EVENTS":case"RECEIVE_EVENT_ERROR":return function(e,
  t,
  n,
  o) {
    var i,a=e[t];
  ...
  (function(n) {
    var r=n.rawEvents;
    i.eventSourceSuccess&&(r=i.eventSourceSuccess.call(a,
  r,
  n.xhr)||r),
  e.success&&(r=e.success.call(a,
  r,
  n.xhr)||r),
  o.dispatch( {
  ...
  n),
  i.eventSourceFailure&&i.eventSourceFailure.call(a,
  n),
  ...
  o) {
    switch(t.type) {
    case"RECEIVE_EVENTS":return function(e,
  t,
  n,
  r,
  o,
  ...
  (e,n[t.sourceId],t.fetchId,t.fetchRange,t.rawEvents,o);
    case"ADD_EVENTS":return function(e,
  t,
  n,
  r) {
    n&&(t=_t(t,n,r));
  ...
  (e,t.eventStore,r?r.activeRange:null,o);
    ...
    case"MERGE_EVENTS":return Dn(e,t.eventStore);
    case"PREV":case"NEXT":case"CHANGE_DATE":case"CHANGE_VIEW_TYPE":return r?_t(e,r.activeRange,o):e;
    case"REMOVE_EVENTS":return function(e,
  t) {
    var n=e.defs,
  r=e.instances,
  o= {}
  ...
  (e,t.eventStore);
    ...
    case"REMOVE_ALL_EVENT_SOURCES":return Tn(e,
  (function(e) {
    return!e.sourceId;
  }
  ...
  o) {
    return {
    header:e.headerToolbar?Ti(e.headerToolbar,e,t,n,r,o):null,footer:e.footerToolbar?Ti(e.footerToolbar,e,t,n,r,o):null;
  }
  }
  ...
  return {
    sectionWidgets:a,viewsWithButtons:s,hasTitle:l;
  }
  }
  ...
  ;
    return {
    buttonName:e,buttonClick:v,buttonIcon:g,buttonText:m,buttonHint:y;
  }
  }
  ...
  o) {
    var i=null;
    "GET"===(e=e.toUpperCase())?t=function(e,
  t) {
  ...
  t,
  !0),
  "GET"!==e&&a.setRequestHeader("Content-Type",
  ...
  function Ri(e,
  t) {
    for(var n=Dt(t.getCurrentData().eventSources),r=[],o=0,i=e;
    o<i.length;
    o++) {
    for(var a=i[o],s=!1,l=0;
    l<n.length;
    l+=1)if(n[l]._raw===a) {
    n.splice(l,1),s=!0;
    break;
  ...
  for(var u=0,c=n;
    ...
    var d=c[u];
    t.dispatch( {
    type:"REMOVE_EVENT_SOURCE",sourceId:d.sourceId;
  }
  ...
  n) {
    ...
    yo(e.eventSource.meta.bind(null,
  hr(e.range,
  r)),
  (function(e) {
    t( {
  ...
  Bo( {
    eventSourceRefiners: {
    method:String,extraParams:yn,startParam:String,endParam:String,timeZoneParam:String;
  }
  ...
  n,
  r) {
    var o=e?wt(e):null,i=lt(n.start),a=n.end,s=[];
    for(;
    i<a;
    ) {
    var l=void 0;
  ...
  eventRefiners: {
    daysOfWeek:yn,startTime:Nt,endTime:Nt,duration:Nt,startRecur:yn,endRecur:yn;
  }
  }
  ...
  n.formatRange(r.start,
  r.end,
  ln(t.titleFormat||function(e) {
  ...
  ,o=this.computeOptionsData(e.optionOverrides,n,e.calendarApi),i=o.calendarOptions.initialView||o.pluginHooks.initialView,a=this.computeCurrentViewData(i,o,e.optionOverrides,n);
    e.calendarApi.currentDataManager=this,this.emitter.setThisContext(e.calendarApi),this.emitter.setOptions(a.options);
    var s,l,u,c=(s=o.calendarOptions,l=o.dateEnv,null!=(u=s.initialDate)?l.createMarker(u):kr(s.now,l)),d=a.dateProfileGenerator.build(c);
  ...
  ,f=0,h=o.pluginHooks.contextInit;
    f<h.length;
    f++) {
    (0,h[f])(p);
  }
  ...
  ,dateSelection:null,eventSelection:"",eventDrag:null,eventResize:null,selectionConfig:this.buildViewUiProps(p).selectionConfig;
  }

  ,
  m=r(r( {}

  ,p),g),y=0,E=o.pluginHooks.reducers;
    y<E.length;
    y++) {
    var b=E[y];
    r(g,b(null,null,m));
  ...
  return e.prototype.resetOptions=function(e,
  t) {
    var n=this.props;
  ...
  (o.dynamicOptionOverrides,
  e),
  s=this.computeOptionsData(n.optionOverrides,
  a,
  n.calendarApi),
  l=function(e,
  t) {
  ...
  (o.currentViewType,e),u=this.computeCurrentViewData(l,s,n.optionOverrides,a);
    ...
    var c= {
    dateEnv:s.dateEnv,options:s.calendarOptions,pluginHooks:s.pluginHooks,calendarApi:n.calendarApi,dispatch:this.dispatch,emitter:i,getCurrentData:this.getCurrentData;
  }
  ...
  r) {
    ...
    break;
    case"NEXT":if((o=r.buildNext(e,n)).isValid)return o;
  }
  ...
  d=this.state,
  p=this.data,
  f=this.computeOptionsData(c.optionOverrides,
  d.dynamicOptionOverrides,
  c.calendarApi),
  h=this.computeCurrentViewData(d.currentViewType,
  f,
  c.optionOverrides,
  d.dynamicOptionOverrides),
  v=this.data=r(r(r( {
  ...
  ,
  e.prototype._computeOptionsData=function(e,
  t,
  n) {
  ...
  ,
  e.prototype.processRawCalendarOptions=function(e,
  t) {
    var n=gn([cn,
  e,
  t]),
  ...
  ,h=this.currentCalendarOptionsInput,v=this.currentCalendarOptionsRefined,g=!1;
  ...
  ,
  e.prototype._computeCurrentViewData=function(e,
  t,
  n,
  r) {
    var o=t.viewSpecs[e];
  ...
  ,
  e.prototype.processRawViewOptions=function(e,
  t,
  n,
  o,
  i) {
  ...
  function Vi(e,
  t) {
    for(var n=0,r=t.pluginHooks.isLoadingFuncs;
    n<r.length;
    n++) {
    if((0,r[n])(e))return!0;
  }
  ...
  ,
  e.prototype.splitEntry=function(e,
  t,
  n) {
  ...
  r?(n.push.apply(n,
  o([ {
    index:e.index,thickness:e.thickness,span:Ki(s,a);
  }
  ...
  ,
  e.prototype.insertEntryAt=function(e,
  t) {
  ...
  e.prototype.findInsertion=function(e) {
    for(var t=this,n=t.levelCoords,r=t.entriesByLevel,o=t.strictOrder,i=t.stackCnts,a=n.length,s=0,l=-1,u=-1,c=null,d=0,p=0;
    p<a;
    p+=1) {
    var f=n[p];
  ...
  var E=0;
    ...
    var b=-1;
    return E<a&&n[E]===s&&(b=Qi(r[E],
  e.span.end,
  Yi)[0]),
   {
    touchingLevel:l,touchingLateral:u,touchingEntry:c,stackCnt:d,levelCoord:s,level:E,lateral:b;
  }
  }

  ,
  e.prototype.toRects=function() {
    for(var e=this.entriesByLevel,t=this.levelCoords,n=e.length,o=[],i=0;
    i<n;
  ...
  ,s=0,l=t;
    ...
    Ki(u.span,
  a.span)?a= {
    entries:u.entries.concat(a.entries),span:Xi(u.span,a.span);
  }
  ...
  t) {
    return {
    start:Math.min(e.start,t.start),end:Math.max(e.end,t.end);
  }
  }
  ...
  ,
  aa= {
    startTime:Nt,duration:Nt,create:Boolean,sourceId:String;
  }
  ...
  ;
    ...
    return {
    startTime:n.startTime||null,duration:n.duration||null,create:null==n.create||n.create,sourceId:n.sourceId,leftoverProps:r;
  }
  }
  ...
  t.prototype.renderWidgetGroup=function(e) {
    for(var t=this.props,n=this.context.theme,r=[],i=!0,a=0,s=e;
    a<s.length;
    a++) {
  ...
  t) {
    ...
    return Co(la,
   {
    key:e,widgetGroups:t,title:n.title,navUnit:n.navUnit,activeButton:n.activeButton,isTodayEnabled:n.isTodayEnabled,isPrevEnabled:n.isPrevEnabled,isNextEnabled:n.isNextEnabled,titleId:n.titleId;
  }
  ...
  da=function(e) {
    function t(t) {
    var n=e.call(this,t)||this;
    return n.handleSegClick=function(e,
  t) {
   ...
   {
    el:t,event:new _r(r.context,i.eventRange.def,i.eventRange.instance),jsEvent:e,view:o.viewApi;
  }
  ...
  n) {
   ...
   {
    el:n,event:new _r(o,i.eventRange.def,i.eventRange.instance),jsEvent:t,view:o.viewApi;
  }
  ...
  fa=function(e) {
    function t() {
    var t=null!==e&&e.apply(this,arguments)||this;
    return t.buildViewContext=qt(Oo),
  ...
  ,
  t.registerInteractiveComponent=function(e,
  n) {
    var r=ta(e,
  n),
  o=[da,
  pa].concat(t.props.pluginHooks.componentInteractions).map((function(e) {
    return new e(r);
  }
  ...
  t.resizeRunner=new Mi((function() {
    t.props.emitter.trigger("_resize",
  !0),
  ...
  e),
  t.prototype.render=function() {
    var e,t=this.props,n=t.toolbarConfig,o=t.options,i=this.buildToolbarProps(t.viewSpec,t.dateProfile,t.dateProfileGenerator,t.currentDate,kr(t.options.now,t.dateEnv),t.viewTitle),a=!1,s="";
  ...
  n.header&&Co(ua,
  r( {
    ref:this.headerRef,extraClassName:"fc-header-toolbar",model:n.header,titleId:u;
  }
  ...
  ,i=0,a=this.buildViewPropTransformers(t.viewPropsTransformers);
    i<a.length;
    i++) {
    var s=a[i];
    r(o,s.transform(o,e));
  ...
  i) {
    ...
    return {
    title:i,activeButton:e.type,navUnit:e.singleUnit,isTodayEnabled:a.isValid&&!Zn(t.currentRange,o),isPrevEnabled:s.isValid,isNextEnabled:l.isValid;
  }
  }
  ...
  d=t.format(s,
  a.dayHeaderFormat),
  p=!u.isDisabled&&a.colCnt>1?so(this.context,
  s): {}
  ...
  o) {
    return Co("th",
  r( {
    ref:e,role:"columnheader",className:c.concat(t).join(" "),"data-date":u.isDisabled?void 0:Ft(s),colSpan:a.colSpan;
  }
  ...
  !u.isDisabled&&Co("a",
  r( {
    ref:n,className:["fc-col-header-cell-cushion",a.isSticky?"fc-sticky":""].join(" ");
  }
  ...
  a) {
    return Co("th",
  r( {
    ref:t,role:"columnheader",className:u.concat(o).join(" "),colSpan:e.colSpan;
  }
  ...
  Co("a",
   {
    "aria-label":n.format(s,Sa),className:["fc-col-header-cell-cushion",e.isSticky?"fc-sticky":""].join(" "),ref:i;
  }
  ...
  t.prototype.computeTiming=function() {
    ...
    return i=Math.min(864e5,
  i),
   {
    currentState: {
    nowDate:r,todayRange:Ta(r);
  }

  ,
  nextState: {
    nowDate:o,todayRange:Ta(o);
  }
  ...
  n.map((function(e) {
   ...
   {
    key:e.getUTCDay(),dow:e.getUTCDay(),dayHeaderFormat:a;
  }
  ...
  var ka=function() {
    function e(e,
  t) {
    for(var n=e.start,r=e.end,o=[],i=[],a=-1;
    n<r;
  ...
  ,
  e.prototype.buildCell=function(e,
  t) {
  ...
  return e.prototype.sliceProps=function(e,
  t,
  n,
  r) {
    for(var i=[],a=4;
  ...
  ,
  e.prototype.sliceNowDate=function(e,
  t) {
    for(var n=[],r=2;
    r<arguments.length;
    r++)n[r-2]=arguments[r];
  ...
  ,
  e.prototype._sliceBusinessHours=function(e,
  t,
  n,
  r) {
    for(var i=[],a=4;
    a<arguments.length;
    a++)i[a-4]=arguments[a];
    return e?this._sliceEventStore.apply(this,
  o([_t(e,
  Ma(t,
  Boolean(n)),
  r),
  ...
  ,
  e.prototype._sliceEventStore=function(e,
  t,
  n,
  r) {
    for(var o=[],i=4;
    ...
    return {
    bg:this.sliceEventRanges(a.bg,o),fg:this.sliceEventRanges(a.fg,o);
  }
  }
  ...
  ,
  e.prototype._sliceInteraction=function(e,
  t,
  n,
  r) {
    for(var o=[],i=4;
    ...
    return {
    segs:this.sliceEventRanges(a.fg,o),affectedInstances:e.affectedEvents.instances,isEvent:e.isEvent;
  }
  }

  ,
  e.prototype._sliceDateSpan=function(e,
  t,
  n) {
    for(var r=[],i=3;
    i<arguments.length;
  ...
  ,
  e.prototype.sliceEventRanges=function(e,
  t) {
    for(var n=[],r=0,o=e;
    r<o.length;
    r++) {
  ...
  ,
  e.prototype.sliceEventRange=function(e,
  t) {
    var n=e.range;
    this.forceDayIfListItem&&"list-item"===e.ui.display&&(n= {
    start:n.start,end:tt(n.start,1);
  }
  ...
  o=r( {
    businessHours:n.businessHours,dateSelection:"",eventStore:n.eventStore,eventUiBases:n.eventUiBases,eventSelection:"",eventDrag:null,eventResize:null;
  }
  ...
  (function(e) {
    ...
    var v,g;
    for(var m in u) {
    var y=u[m],E=y.range,b=c[y.defId],S=l[y.defId];
  ...
  x.range)) {
    ...
    if(D&&!D(new _r(t,p[x.defId],x),new _r(t,S,y)))return!1;
  }
  }

  for(var C=i.eventStore,k=0,R=b.allows;
    k<R.length;
    k++) {
    var _=R[k],
  M=r(r( {}
  ...
  n),
   {
    range:y.range,allDay:S.allDay;
  }

  ),I=C.defs[S.defId],P=C.instances[m],N=void 0;
    if(N=I?new _r(t,I,P):new _r(t,S),!_(yr(M,t),N))return!1;
  }
  }
  ...
  r,
  o) {
    return"businessHours"===e?La(_t(r,
  t,
  o)):"string"==typeof e?La(Tn(n,
  (function(t) {
    return t.groupId===e;
  }
  ...
  ();
    function Fa(e) {
    for(var t=0,n=0,r=we(e,".fc-scrollgrid-shrink");
    n<r.length;
    n++) {
    var o=r[n];
    t=Math.max(t,Je(o));
  ...
  e.syncRowHeights?"fc-scrollgrid-sync-table":""].join(" "),
  style: {
  ...
  t) {
   ...
   {
    style: {
    width:"shrink"===a.width?Za(t):a.width||"",minWidth:a.minWidth||"";
  }
  }
  ...
  e),
  t.prototype.render=function() {
    var e=this,t=e.props,n=e.state,r=e.context,i=t.sections||[],a=this.processCols(t.cols),s=this.renderMicroColGroup(a,n.shrinkWidth),l=Xa(t.liquid,r);
  ...
  e.outerContent):Co("tr",
   {
    key:e.key,role:"presentation",className:Ka(e,this.props.liquid).join(" ");
  }
  ...
  ,
  t.prototype.renderChunkTd=function(e,
  t,
  n,
  r) {
  ...
  Co(za,
   {
    ref:this.scrollerRefs.createRef(p),elRef:this.scrollerElRefs.createRef(p),overflowY:d,overflowX:o.liquid?"hidden":"visible",maxHeight:e.maxHeight,liquid:c,liquidIsAbsolute:!0;
  }
  ...
  ,
  t.prototype._handleScrollerEl=function(e,
  t) {
    var n=function(e,
  t) {
    for(var n=0,r=e;
  ...
  for(var l=0,u=this.props.sections;
    l<u.length;
    l++) {
    a=u[l].key;
  ...
  return {
    forceYScrollbars:r,scrollerClientWidths:o,scrollerClientHeights:i;
  }
  }
  ...
  (Uo);
    ts.addStateEquality( {
    scrollerClientWidths:Tt,scrollerClientHeights:Tt;
  }
  ...
  t.prototype.render=function() {
    ...
    return Co(ns,
   {
    seg:n,timeText:i,disableDragging:e.disableDragging,disableResizing:e.disableResizing,defaultContent:e.defaultContent||os,isDragging:e.isDragging,isResizing:e.isResizing,isDateSelecting:e.isDateSelecting,isSelected:e.isSelected,isPast:e.isPast,isFuture:e.isFuture,isToday:e.isToday;
  }
  ...
  style: {
    borderColor:l.borderColor,backgroundColor:l.backgroundColor;
  }
  ...
  (function(t) {
    var n=t.options,
  r= {
    isAxis:e.isAxis,date:t.dateEnv.toDate(e.date),view:t.viewApi;
  }
  ...
  o=oo(r,
  t.theme).concat(r.isDisabled?[]:this.normalizeClassNames(n.dayCellClassNames,
  r)),
  i=r.isDisabled? {}
  ...
  ,classNames:r.weekNumberClassNames,content:r.weekNumberContent,defaultContent:hs,didMount:r.weekNumberDidMount,willUnmount:r.weekNumberWillUnmount;
  }
  ...
  t.prototype.render=function() {
    ...
    return Io(Co("div",
  r( {
    id:o.id,className:a.join(" "),"aria-labelledby":i.titleId;
  }
  ...
  o=this.rootEl,
  i=function(e) {
    for(var t=mo(e),n=e.getBoundingClientRect(),r=0,o=t;
    r<o.length;
    r++) {
  ...
  (n);
    if(i) {
    var a=o.getBoundingClientRect(),s=r?be(n,".fc-scrollgrid").getBoundingClientRect().top:i.top,l=e?i.right-a.width:i.left;
  ...
  ms=function(e) {
    function t() {
    var t=null!==e&&e.apply(this,arguments)||this;
    return t.linkElRef=Ro(),
  t.state= {
    isPopoverOpen:!1,popoverId:_e();
  }
  ...
  t.handleClick=function(e) {
    ...
    return {
    event:new _r(o,n,r),start:o.dateEnv.toDate(i.start),end:o.dateEnv.toDate(i.end),isStart:e.isStart,isEnd:e.isEnd;
  }
  }

  "function"==typeof i&&(i=i( {
    date:a,allDay:Boolean(r.allDayDate),allSegs:r.allSegs.map(s),hiddenSegs:r.hiddenSegs.map(s),jsEvent:e,view:o.viewApi;
  }

  )),
  i&&"popover"!==i?"string"==typeof i&&o.calendarApi.zoomTo(a,
  i):t.setState( {
    isPopoverOpen:!0;
  }
  ...
  l=t.moreCnt,
  u=Es(t),
  c="function"==typeof s?s.call(a,
  l):"+"+l+" "+s,
  d=$e(i.moreLinkHint,
  [l],
  c),
  p= {
    num:l,shortText:"+"+l,text:c,view:o;
  }

  ;
    return Co(_o,
  null,
  Boolean(t.moreCnt)&&Co(Yo,
   {
    elRef:e.linkElRef,hookProps:p,classNames:i.moreLinkClassNames,content:i.moreLinkContent,defaultContent:t.defaultContent||ys,didMount:i.moreLinkDidMount,willUnmount:i.moreLinkWillUnmount;
  }
  ...
  n.isPopoverOpen&&Co(gs,
   {
    id:n.popoverId,startDate:u.start,endDate:u.end,dateProfile:t.dateProfile,todayRange:t.todayRange,extraDateSpan:t.extraDateSpan,parentEl:e.parentEl,alignmentEl:t.alignmentElRef.current,alignGridTop:t.alignGridTop,onClose:e.handlePopoverClose;
  }
  ...
  function Es(e) {
    ...
    start:e.allDayDate,end:tt(e.allDayDate,1);
  }

  ;
    var t,n=e.hiddenSegs;
    return {
    start:bs(n),end:(t=n,t.reduce(ws).eventRange.range.end);
  }
  }
  ...
  o.handleAction=function(e) {
    switch(e.type) {
    case"SET_EVENT_DRAG":case"SET_EVENT_RESIZE":o.renderRunner.tryDrain();
  }
  }
  ...
  ,
  t.prototype.resetOptions=function(e,
  t) {
  ...
  this.currentClassNames)) {
    for(var t=this.el.classList,n=0,r=this.currentClassNames;
    n<r.length;
    n++) {
    var o=r[n];
    t.remove(o);
  ...
  t.handleTouchMove),
  n.removeEventListener("touchend",
  t.handleTouchEnd),
  n.removeEventListener("touchcancel",
  t.handleTouchEnd),
  window.removeEventListener("scroll",
  t.handleTouchScroll,
  !0),
  t.emitter.trigger("pointerup",
  ...
  1===(xs+=1)&&window.addEventListener("touchmove",
  Rs,
   {
    passive:!1;
  }
  ...
  (xs-=1)||window.removeEventListener("touchmove",
  Rs,
   {
    passive:!1;
  }
  ...
  ,
  e.prototype.createEventFromMouse=function(e,
  t) {
    var n=0,r=0;
  ...
  ,
  e.prototype.createEventFromTouch=function(e,
  t) {
  ...
  ,
  e.prototype.doRevertAnimation=function(e,
  t) {
    var n=this.mirrorEl,r=this.sourceEl.getBoundingClientRect();
    n.style.transition="top "+t+"ms,
  left "+t+"ms",
  Te(n,
   {
  ...
  e.prototype.updateElPosition=function() {
   ...
   {
    left:this.sourceElRect.left+this.deltaX,top:this.sourceElRect.top+this.deltaY;
  }
  ...
  ,
  e.prototype.handleSide=function(e,
  t) {
    ...
    break;
    case"top":a=-1;
    case"bottom":n.setScrollTop(n.getScrollTop()+i*a);
  }
  }

  ,
  e.prototype.computeBestEdge=function(e,
  t) {
    for(var n=this.edgeThreshold,r=null,o=0,i=this.scrollCaches||[];
    o<i.length;
    o++) {
  ...
  e.prototype.queryScrollEls=function(e) {
    for(var t=[],n=0,r=this.scrollQuery;
    n<r.length;
    n++) {
    var o=r[n];
  ...
  r.onPointerMove=function(e) {
    if(r.isInteracting) {
    if(r.emitter.trigger("pointermove",
  e),
  ...
  e.prototype.computeLeft=function() {
    for(var e=this.origRect.left,t=0,n=this.scrollCaches;
    t<n.length;
    t++) {
    var r=n[t];
  ...
  e.prototype.computeTop=function() {
    for(var e=this.origRect.top,t=0,n=this.scrollCaches;
    t<n.length;
    t++) {
    var r=n[t];
  ...
  ,
  e.prototype.isWithinClipping=function(e,
  t) {
    for(var n,
  r,
  o= {
  ...
  e.prototype.prepareHits=function() {
    this.offsetTrackers=St(this.droppableStore,
  (function(e) {
  ...
  ,a=0,s=t.pluginHooks.datePointTransforms;
    a<s.length;
    a++) {
    var l=s[a];
    r(i,l(e,t));
  ...
  s)),
   {
    dayEl:i.dayEl,jsEvent:e.origEvent,view:s.viewApi||s.calendarApi.view;
  }
  ...
  ,
  n.handleHitUpdate=function(e,
  t) {
    var o=n.component.context,i=null,a=!1;
    if(e) {
    var s=n.hitDragging.initialHit;
    e.componentId===s.componentId&&n.isHitComboAllowed&&!n.isHitComboAllowed(s,
  e)||(i=function(e,
  t,
  n) {
  ...
  ;
    var o=t.component.context.options,i=n.dragging=new As(t.el);
  ...
  o.handlePointerDown=function(e) {
    ...
    o.relevantEvents=Sn(l.getCurrentData().eventStore,
  c),
  ...
  t.emitter.trigger("eventDragStart",
   {
    el:o.subjectEl,event:new _r(t,n.def,n.instance),jsEvent:e.origEvent,view:t.viewApi;
  }
  ...
  ;
    ...
    i===a||d.editable&&d.droppable?(s=function(e,
  t,
  n) {
    var r=e.dateSpan,
  o=t.dateSpan,
  ...
  (r,
  e,
  a.getCurrentData().pluginHooks.eventDragMutationMassagers))&&(l=br(n,
  ...
  o.handleDragEnd=function(e) {
    if(o.isDragging) {
    var t=o.component.context,n=t.viewApi,i=o,a=i.receivingContext,s=i.validMutation,l=o.eventRange.def,u=o.eventRange.instance,c=new _r(t,l,u),d=o.relevantEvents,p=o.mutatedRelevantEvents,f=o.hitDragging.finalHit;
    if(o.clearDrag(),
  ...
  s) {
    ...
    t.dispatch( {
    type:"MERGE_EVENTS",eventStore:p;
  }
  ...
  revert:function() {
    t.dispatch( {
    type:"MERGE_EVENTS",eventStore:d;
  }
  ...
  ,m=0,y=t.getCurrentData().pluginHooks.eventDropTransformers;
    m<y.length;
    m++) {
    var E=y[m];
    r(g,E(s,t));
  ...
  g),
   {
    el:e.subjectEl,delta:s.datesDelta,jsEvent:e.origEvent,view:n;
  }
  ...
  ;
    t.emitter.trigger("eventLeave",
  r(r( {}

  ,
  b),
   {
    draggedEl:e.subjectEl,view:n;
  }

  )),
  t.dispatch( {
    type:"REMOVE_EVENTS",eventStore:d;
  }

  ),t.emitter.trigger("eventRemove",b);
    var S=p.defs[l.defId],w=p.instances[u.instanceId],D=new _r(a,S,w);
    a.dispatch( {
    type:"MERGE_EVENTS",eventStore:p;
  }
  ...
  revert:function() {
    a.dispatch( {
    type:"REMOVE_EVENTS",eventStore:p;
  }
  ...
  e.isTouch&&a.dispatch( {
    type:"SELECT_EVENT",eventInstanceId:u.instanceId;
  }

  ),
  a.emitter.trigger("drop",
  r(r( {}
  ...
  a)),
   {
    draggedEl:e.subjectEl,jsEvent:e.origEvent,view:f.context.viewApi;
  }

  )),
  a.emitter.trigger("eventReceive",
  r(r( {}

  ,
  T),
   {
    draggedEl:e.subjectEl,view:f.context.viewApi;
  }
  ...
  ;
    var i=o.component.context.options,a=o.dragging=new As(n.el);
  ...
  ,
  t.prototype.displayDrag=function(e,
  t) {
  ...
  n.handleDragStart=function(e) {
    ...
    n.relevantEvents=Sn(t.getCurrentData().eventStore,n.eventRange.instance.instanceId);
  ...
  t.emitter.trigger("eventResizeStart",
   {
    el:o,event:new _r(t,r.def,r.instance),jsEvent:e.origEvent,view:t.viewApi;
  }
  ...
  ;
    e&&(e.componentId===a.componentId&&n.isHitComboAllowed&&!n.isHitComboAllowed(a,
  e)||(l=function(e,
  t,
  n,
  r) {
    var o=e.context.dateEnv,i=e.dateSpan.range.start,a=t.dateSpan.range.start,s=Vn(i,a,o,e.largeUnit);
    if(n) {
    if(o.add(r.start,
  s)<r.end)return {
    startDelta:s;
  ...
  ,
  n.handleDragEnd=function(e) {
    var t=n.component.context,o=n.eventRange.def,i=n.eventRange.instance,a=new _r(t,o,i),s=n.relevantEvents,l=n.mutatedRelevantEvents;
  ...
  n.validMutation) {
    ...
    t.dispatch( {
    type:"MERGE_EVENTS",eventStore:l;
  }
  ...
  revert:function() {
    t.dispatch( {
    type:"MERGE_EVENTS",eventStore:s;
  }
  ...
  c),
   {
    el:n.draggingSegEl,startDelta:n.validMutation.startDelta||Nt(0),endDelta:n.validMutation.endDelta||Nt(0),jsEvent:e.origEvent,view:t.viewApi;
  }
  ...
  ;
    var o=t.component,i=n.dragging=new As(t.el);
  ...
  this.onDocumentPointerDown=function(e) {
    var n=t.context.options.unselectCancel,r=Ce(e.origEvent);
  ...
  ,
  qs= {
    dateClick:yn,eventDragStart:yn,eventDragStop:yn,eventDrop:yn,eventResizeStart:yn,eventResizeStop:yn,eventResize:yn,drop:yn,eventReceive:yn,eventLeave:yn;
  }
  ...
  ,
  this.handleHitUpdate=function(e,
  t,
  o) {
  ...
  ;
    e&&(a=e.context,
  n.canDropElOnCalendar(o.subjectEl,
  a)&&(s=function(e,
  t,
  n) {
    for(var o=r( {}
  ...
  var l=An(o,n),u=l.refined,c=l.extra,d=Ln(u,c,t.sourceId,e.allDay,n.options.forceEventDuration||Boolean(t.duration),n),p=e.range.start;
    e.allDay&&t.startTime&&(p=n.dateEnv.add(p,t.startTime));
    var f=t.duration?n.dateEnv.add(p,
  t.duration):Er(e.allDay,
  p,
  n),
  h=mt(d.defId,
   {
  ...
  o)),
   {
    draggedEl:e.subjectEl,jsEvent:e.origEvent,view:s;
  }
  ...
  l.create) {
    var u=bn(i);
    o.dispatch( {
    type:"MERGE_EVENTS",eventStore:u;
  }
  ...
  revert:function() {
    o.dispatch( {
    type:"REMOVE_EVENTS",eventStore:u;
  }
  ...
  return e.prototype.buildDragMeta=function(e) {
    return"object"==typeof this.suppliedDragMeta?sa(this.suppliedDragMeta):"function"==typeof this.suppliedDragMeta?sa(this.suppliedDragMeta(e)):(t=function(e,
  t) {
  ...
  ,
  e.prototype.displayDrag=function(e,
  t) {
  ...
  ,
  e.prototype.canDropElOnCalendar=function(e,
  t) {
    var n=t.options.dropAccept;
    return"function"==typeof n?n.call(t.calendarApi,e):"string"!=typeof n||!n||Boolean(Se(e,n));
  }
  ...
  (),
  Ks=Bo( {
    componentInteractions:[zs,Vs,Fs,Bs],calendarInteractions:[js],elementDraggingImpl:As,optionRefiners:Gs,listenerRefiners:qs;
  }
  ...
  return n(t,
  e),
  t.prototype.renderSimpleLayout=function(e,
  t) {
  ...
  Co(ts,
   {
    liquid:!n.isHeightAuto&&!n.forPrint,collapsibleWidth:n.forPrint,cols:[],sections:o;
  }
  ...
  ,
  t.prototype.renderHScrollLayout=function(e,
  t,
  n,
  r) {
  ...
  e,
   {
    extraClassNames:["fc-daygrid-event","fc-daygrid-block-event","fc-h-event"],defaultTimeFormat:ol,defaultDisplayEventEnd:e.defaultDisplayEventEnd,disableResizing:!e.seg.eventRange.def.allDay;
  }
  ...
  a) {
    return Co("a",
  r( {
    className:["fc-daygrid-event","fc-daygrid-dot-event"].concat(o).join(" "),ref:n;
  }
  ...
  il(n)?Co(sl,
  r( {
    seg:n,isDragging:!1,isSelected:o===e.eventSelection,defaultDisplayEventEnd:!1;
  }
  ...
  l) {
    return Co("a",
  r( {
    ref:e,className:["fc-daygrid-more-link"].concat(t).join(" "),title:a,"aria-expanded":s,"aria-controls":l;
  }
  ...
  o) {
    return Co("a",
  r( {
    ref:e,className:["fc-daygrid-week-number"].concat(t).join(" ");
  }
  ...
  !c&&Co(nl,
   {
    date:a,dateProfile:s,showDayNumber:n.showDayNumber,dayNumberId:o.dayNumberId,forceDayTop:n.forceDayTop,todayRange:n.todayRange,extraHookProps:n.extraHookProps;
  }
  ...
  Co(ul,
   {
    allDayDate:a,singlePlacements:n.singlePlacements,moreCnt:n.moreCnt,alignmentElRef:i,alignGridTop:!n.showDayNumber,extraDateSpan:n.extraDateSpan,dateProfile:n.dateProfile,eventSelection:n.eventSelection,eventDrag:n.eventDrag,eventResize:n.eventResize,todayRange:n.todayRange;
  }
  ...
  thickness:d,
  span: {
    start:x.firstCol,end:x.lastCol+1;
  }
  }
  ...
  (e,n.length),o=[],i=[],a=[],s=0;
    s<n.length;
    s+=1) {
    for(var l=r[s],u=[],c=0,d=0,p=0,f=l;
    p<f.length;
    p++) {
    var h=t[(y=f[p]).index];
    u.push( {
    seg:hl(h,s,s+1,n),isVisible:!0,isAbsolute:!1,absoluteTop:y.levelCoord,marginTop:y.levelCoord-c;
  }
  ...
  E?(d+=y.thickness,
  b&&v.push( {
    seg:hl(h,y.span.start,y.span.end,n),isVisible:!0,isAbsolute:!0,absoluteTop:y.levelCoord,marginTop:0;
  }

  )):b&&(v.push( {
    seg:hl(h,y.span.start,y.span.end,n),isVisible:!0,isAbsolute:!1,absoluteTop:y.levelCoord,marginTop:d;
  }
  ...
  return {
    singleColPlacements:o,multiColPlacements:i,leftoverMargins:a;
  }
  }

  (s.toRects(),e,a),h=f.singleColPlacements,v=f.multiColPlacements,g=f.leftoverMargins,m=[],y=[],E=0,b=u;
    E<b.length;
    E++) {
    v[(x=b[E]).firstCol].push( {
    seg:x,isVisible:!1,isAbsolute:!0,absoluteTop:0,marginTop:0;
  }

  );
    for(var S=x.firstCol;
    S<=x.lastCol;
    S+=1)h[S].push( {
    seg:hl(x,S,S+1,a),isVisible:!1,isAbsolute:!1,absoluteTop:0,marginTop:0;
  }
  ...
  for(S=0;
    ...
    w<D.length;
    w++) {
    var T=D[w],x=e[T.index],C=T.span;
    v[C.start].push( {
    seg:hl(x,C.start,C.end,a),isVisible:!1,isAbsolute:!0,absoluteTop:0,marginTop:0;
  }
  ...
  for(S=0;
    ...
    S+=1)y.push(g[S]);
    return {
    singleColPlacements:h,multiColPlacements:v,moreCnts:m,moreMarginTops:y;
  }
  }
  ...
  s=jn(a,
   {
    start:o[t].date,end:tt(o[n-1].date,1);
  }
  ...
  t.prototype.addSegs=function(t) {
    for(var n=this,
  r=e.prototype.addSegs.call(this,
  t),
  ...
  ,
  t.prototype.handleInvalidInsertion=function(t,
  n,
  o) {
  ...
  o=t.context.options,
  i=n.cells.length,
  a=el(n.businessHourSegs,
  i),
  s=el(n.bgEventSegs,
  i),
  l=el(this.getHighlightSegs(),
  i),
  u=el(this.getMirrorSegs(),
  i),
  c=fl(tr(n.fgEventSegs,
  o.eventOrder),
  n.dayMaxEvents,
  n.dayMaxEventRows,
  o.eventOrderStrict,
  ...
  n.cells.map((function(t,
  r) {
    var o=e.renderFgSegs(r,
  n.forPrint?d[r]:p[r],
  n.todayRange,
  v),
  i=e.renderFgSegs(r,
  ...
  (t);
    return e.map((function(e) {
    return {
    seg:e,isVisible:!0,isAbsolute:!0,absoluteTop:n[e.eventRange.instance.instanceId],marginTop:0;
  }
  }
  ...
  s) {
    ...
    h<v.length;
    h++) {
    var g=v[h],m=g.seg,y=m.eventRange.instance.instanceId,E=y+":"+e,b=g.isVisible&&!o[y],S=g.isAbsolute,w="",D="";
    S&&(l.isRtl?(D=0,
  w=c.lefts[m.lastCol]-c.lefts[m.firstCol]):(w=0,
  ...
  style: {
    visibility:b?"":"hidden",marginTop:S?"":g.marginTop,top:S?g.absoluteTop:"",left:w,right:D;
  }
  }
  ...
  il(m)?Co(sl,
  r( {
    seg:m,isDragging:i,isSelected:y===u,defaultDisplayEventEnd:d;
  }
  ...
  ,
  t.prototype.renderFillSegs=function(e,
  t) {
  ...
  ,a),s),maxContentHeight:l?this.computeMaxContentHeight():null;
  }
  ...
  e?t.context.registerInteractiveComponent(t,
   {
    el:e,isHitComboAllowed:t.props.isHitComboAllowed;
  }
  ...
  Co("div",
   {
    className:["fc-daygrid-body",
  f?"fc-daygrid-body-balanced":"fc-daygrid-body-unbalanced",
  i?"":"fc-daygrid-body-natural"].join(" "),
  ref:this.handleRootEl,
  style: {
    width:t.clientWidth,minWidth:t.tableMinWidth;
  }
  }
  ...
  style: {
    width:t.clientWidth,minWidth:t.tableMinWidth,height:i?t.clientHeight:"";
  }
  }
  ...
  ,
  t.prototype.prepareHits=function() {
    this.rowPositions=new bo(this.rootEl,
  ...
  ,
  s.extraDateSpan),
  dayEl:this.getCellEl(a,
  i),
  rect: {
    left:n.lefts[i],right:n.rights[i],top:o.tops[a],bottom:o.bottoms[a];
  }
  ...
  ,
  t.prototype.getCellEl=function(e,
  t) {
    return this.rowRefs.currentMap[e].getCellEls()[t];
  }

  ,
  t.prototype.getCellRange=function(e,
  t) {
  ...
  o=this.props,
  i=this.buildDayTableModel(o.dateProfile,
  r),
  a=n.dayHeaders&&Co(xa,
   {
    ref:this.headerRef,dateProfile:o.dateProfile,dates:i.headerDates,datesRepDistinctDays:1===i.rowCnt;
  }
  ...
  return n(t,
  e),
  t.prototype.buildRenderRange=function(t,
  n,
  r) {
  ...
  views: {
    dayGrid: {
    component:Sl,dateProfileGeneratorClass:Dl;
  }
  ...
  (function(n) {
   ...
   {
    className:t.join(" "),"data-time":e.isoTimeStr;
  }
  ...
  ;
    return Co(Yo,
   {
    hookProps:s,classNames:o.slotLabelClassNames,content:o.slotLabelContent,defaultContent:Rl,didMount:o.slotLabelDidMount,willUnmount:o.slotLabelWillUnmount;
  }
  ...
  Il=function(e) {
    function t() {
    var t=null!==e&&e.apply(this,arguments)||this;
    return t.allDaySplitter=new xl,
  t.headerElRef=Ro(),
  t.rootElRef=Ro(),
  t.scrollerElRef=Ro(),
  t.state= {
  ...
  Co("a",
  r( {
    ref:o,className:"fc-timegrid-axis-cushion fc-scrollgrid-shrink-cushion fc-scrollgrid-sync-inner";
  }
  ...
  o=n.viewApi,
  i= {
    text:r.allDayText,view:o;
  }

  ;
    return Co(Yo,
   {
    hookProps:i,classNames:r.allDayClassNames,content:r.allDayContent,defaultContent:Pl,didMount:r.allDayDidMount,willUnmount:r.allDayWillUnmount;
  }
  ...
  Co("span",
   {
    className:"fc-timegrid-axis-cushion fc-scrollgrid-shrink-cushion fc-scrollgrid-sync-inner",ref:r;
  }
  ...
  chunk: {
    scrollerElRef:this.scrollerElRef,content:n;
  }
  }
  ...
  ,
  e.prototype.computeDateTop=function(e,
  t) {
  ...
  t.prototype.render=function() {
    ...
    return Co("tbody",
  null,
  e.slatMetas.map((function(i,
  a) {
    var s= {
    time:i.time,date:t.dateEnv.toDate(i.date),view:t.viewApi;
  }
  ...
  style: {
    minWidth:e.tableMinWidth,width:e.clientWidth,height:e.minHeight;
  }
  }
  ...
  Co(Hl,
   {
    slatElRefs:this.slatElRefs,axis:e.axis,slatMetas:e.slatMetas;
  }
  ...
  t.prototype.updateSizing=function() {
    ...
    n.onCoords&&null!==n.clientWidth&&(this.rootElRef.current.offsetHeight&&n.onCoords(new Nl(new bo(this.rootElRef.current,
  ...
  ,onClick:a,title:s,"aria-expanded":l,"aria-controls":u;
  }
  ...
  t,
  n) {
    for(var r=e.levelCoords,o=e.entriesByLevel,i=o[t][n],a=r[t]+i.thickness,s=r.length,l=t;
    l<s&&r[l]<a;
    l+=1);
    for(;
    l<s;
    ...
    if(p<f)return {
    level:l,lateralStart:p,lateralEnd:f;
  }
  }
  ...
  e),
   {
    levelCoord:n,stackDepth:i,stackForward:0;
  }
  ...
  r) {
    ...
    o.push( {
    start:Math.round(s),end:Math.round(l);
  }
  ...
  var ql=ln( {
    hour:"numeric",minute:"2-digit",meridiem:!1;
  }
  ...
  this.props,
   {
    defaultTimeFormat:ql,extraClassNames:e;
  }
  ...
  u) {
    return Co("td",
  r( {
    ref:n,role:"gridcell",className:["fc-timegrid-col"].concat(l,t.extraClassNames||[]).join(" ");
  }
  ...
  ,
  e.renderFillSegs(t.businessHourSegs,
  "non-business"),
  e.renderFillSegs(t.bgEventSegs,
  "bg-event"),
  e.renderFillSegs(t.dateSelectionSegs,
  "highlight")),
  Co("div",
   {
  ...
  ,
  t.prototype.renderPositionedFgSegs=function(e,
  t,
  n,
  o,
  i) {
  ...
  r) {
    ...
    var s=t[a];
    s?o.push( {
    index:a,thickness:1,span:s;
  }

  ):i.push(e[a]);
  }

  for(var l=zl(o,n,r),u=l.segRects,c=l.hiddenGroups,d=[],p=0,f=u;
    p<f.length;
    p++) {
    var h=f[p];
    d.push( {
    seg:e[h.index],rect:h;
  }
  ...
  return {
    segPlacements:d,hiddenGroups:c;
  }
  }

  (e,Gl(e,f,h,d),c,l),b=E.segPlacements,S=E.hiddenGroups;
    return Co(_o,
  null,
  this.renderHiddenGroups(S,
  e),
  b.map((function(e) {
    var s=e.seg,
  l=e.rect,
  ...
  Co(Yl,
  r( {
    seg:s,isDragging:n,isResizing:o,isDateSelecting:i,isSelected:c===v,isShort:E;
  }
  ...
  ,
  t.prototype.renderHiddenGroups=function(e,
  t) {
  ...
  n.map((function(e) {
    ...
    return Co(Ul,
   {
    key:Vt(bs(p)),hiddenSegs:p,top:d.top,bottom:d.bottom,extraDateSpan:r,dateProfile:o,todayRange:i,nowDate:a,eventSelection:s,eventDrag:l,eventResize:u;
  }
  ...
  n.date,
  n.slatCoords,
  o.options.eventMinHeight).map((function(o,
  i) {
    var a=e[i];
    return Co("div",
   {
  ...
  t.prototype.computeSegHStyle=function(e) {
    ...
    var l= {
    zIndex:e.stackDepth+1,left:100*t+"%",right:100*n+"%";
  }
  ...
  Co(Yl,
  r( {
    seg:e,isDragging:!1,isResizing:!1,isDateSelecting:!1,isSelected:t===i,isShort:!1;
  }
  ...
  Co("table",
   {
    role:"presentation",
  style: {
    minWidth:t.tableMinWidth,width:t.clientWidth;
  }
  }
  ...
  t.prototype.updateCoords=function() {
    var e,t=this.props;
    t.onColCoords&&null!==t.clientWidth&&t.onColCoords(new bo(this.rootElRef.current,
  ...
  (Uo);
    ...
    function t() {
    var t=null!==e&&e.apply(this,arguments)||this;
    return t.processSlotOptions=qt(eu),
  t.state= {
    slatCoords:null;
  }
  ...
  t) {
    ...
    if(null!=p&&null!=f) {
    var h=this.props.cells[p],v=l.positions.tops[f],g=l.positions.getHeight(f),m=(t-v)/g,y=f*d+Math.floor(m*d),E=this.props.cells[p].date,b=At(s.slotMinTime,Ot(c,y)),S=o.add(E,b),w=o.add(S,c);
    return {
    dateProfile:s,
  dateSpan:r( {
    range: {
  ...
  dayEl:a.els[p],
  rect: {
    left:a.lefts[p],right:a.rights[p],top:v,bottom:v+g;
  }
  ...
  ,
  e.slicer.sliceProps(t,
  o,
  null,
  n,
  s),
   {
    forPrint:t.forPrint,axis:t.axis,dateProfile:o,slatMetas:t.slatMetas,slotDuration:t.slotDuration,cells:i.cells[0],tableColGroupNode:t.tableColGroupNode,tableMinWidth:t.tableMinWidth,clientWidth:t.clientWidth,clientHeight:t.clientHeight,expandRows:t.expandRows,nowDate:l,nowIndicatorSegs:a&&e.slicer.sliceNowDate(l,n,s),todayRange:u,onScrollTopRequest:t.onScrollTopRequest,onSlatCoords:t.onSlatCoords;
  }
  ...
  t,
  n) {
    for(var r=[],o=0,i=e.headerDates;
    o<i.length;
    o++) {
    var a=i[o];
    r.push( {
    start:n.add(a,t.slotMinTime),end:n.add(a,t.slotMaxTime);
  }
  ...
  l=n||function(e) {
    ...
    for(t=ou.length-1;
    t>=0;
    t-=1)if(null!==(r=Wt(n=Nt(ou[t]),e))&&r>1)return n;
    return e;
  }
  ...
  (r),u=[];
    ...
    u.push( {
    date:c,time:a,key:c.toISOString(),isoTimeStr:Bt(c),isLabeled:d;
  }
  ...
  a=this.props,
  s=a.dateProfile,
  l=this.buildTimeColsModel(s,
  i),
  u=this.allDaySplitter.splitProps(a),
  c=this.buildSlatMetas(s.slotMinTime,
  s.slotMaxTime,
  n.slotLabelInterval,
  n.slotDuration,
  o),
  ...
  u.timed,
   {
    dayTableModel:l,dateProfile:s,axis:p,slotDuration:n.slotDuration,slatMetas:c,forPrint:a.forPrint,tableColGroupNode:t.tableColGroupNode,tableMinWidth:t.tableMinWidth,clientWidth:t.clientWidth,clientHeight:t.clientHeight,onSlatCoords:e.handleSlatCoords,expandRows:t.expandRows,onScrollTopRequest:e.handleScrollTopRequest;
  }
  ...
  views: {
    timeGrid: {
    component:au,usesMinMaxTime:!0,allDaySlot:!0,slotDuration:"00:30:00",slotEventOverlap:!0;
  }
  ...
  d=ro(l,
  u),
  p=o.listDayFormat?n.format(l,
  o.listDayFormat):"",
  f=o.listDaySideFormat?n.format(l,
  o.listDaySideFormat):"",
  h=r( {
    date:n.toDate(l),view:i,textId:c,text:p,sideText:f,navLinkAttrs:so(this.context,l),sideNavLinkAttrs:so(this.context,l,"day",!1);
  }

  ,d),v=["fc-list-day"].concat(oo(d,t));
    return Co(Yo,
   {
    hookProps:h,classNames:o.dayHeaderClassNames,content:o.dayHeaderContent,defaultContent:cu,didMount:o.dayHeaderDidMount,willUnmount:o.dayHeaderWillUnmount;
  }
  ...
  e),
  t.prototype.render=function() {
    var e=this.props,t=this.context,n=e.seg,o=e.timeHeaderId,i=e.eventHeaderId,a=e.dateHeaderId,s=t.options.eventTimeFormat||du;
    return Co(ns,
   {
    seg:n,
  timeText:"",
  ...
  ,isPast:e.isPast,isFuture:e.isFuture,isToday:e.isToday,isSelected:e.isSelected,isDragging:e.isDragging,isResizing:e.isResizing,isDateSelecting:e.isDateSelecting;
  }
  ...
  o) {
    ...
    if(a.allDay?l=!0:zn(e.eventRange.range)?e.isStart?u=ar(e,
  t,
  n,
  null,
  null,
  s.range.start,
  e.end):e.isEnd?u=ar(e,
  t,
  n,
  null,
  null,
  e.start,
  s.range.end):l=!0:u=ar(e,
  t,
  n),
  l) {
    var c= {
    text:n.options.allDayText,view:n.viewApi;
  }

  ;
    return Co(Yo,
   {
    hookProps:c,classNames:i.allDayClassNames,content:i.allDayContent,defaultContent:fu,didMount:i.allDayDidMount,willUnmount:i.allDayWillUnmount;
  }
  ...
  i) {
    return Co("td",
   {
    ref:e,headers:r+" "+o,className:["fc-list-event-time"].concat(t).join(" ");
  }
  ...
  Co("td",
   {
    ref:l,headers:i+" "+a,className:"fc-list-event-title";
  }
  ...
  var hu=function(e) {
    function t() {
    var t=null!==e&&e.apply(this,arguments)||this;
    return t.computeDateVars=qt(gu),
  t.eventStoreToSegs=qt(t._eventStoreToSegs),
  t.state= {
    timeHeaderId:_e(),eventHeaderId:_e(),dateHeaderIdRoot:_e();
  }
  ...
  n=e.viewApi,
  r= {
    text:t.noEventsText,view:n;
  }

  ;
    return Co(Yo,
   {
    hookProps:r,classNames:t.noEventsClassNames,content:t.noEventsContent,defaultContent:vu,didMount:t.noEventsDidMount,willUnmount:t.noEventsWillUnmount;
  }
  ...
  n) {
    ...
    a.push(Co(uu,
   {
    key:f,cellId:h,dayDate:t[d],todayRange:n;
  }
    ...
    a.push(Co(pu,
  r( {
    key:f+":"+m.eventRange.instance.instanceId,seg:m,isDragging:!1,isResizing:!1,isDateSelecting:!1,isSelected:!1,timeHeaderId:s,eventHeaderId:l,dateHeaderId:h;
  }
  ...
  ,
  t.prototype._eventStoreToSegs=function(e,
  t,
  n) {
  ...
  ,
  t.prototype.eventRangesToSegs=function(e,
  t) {
    for(var n=[],r=0,o=e;
    r<o.length;
    r++) {
  ...
  ,
  t.prototype.eventRangeToSegs=function(e,
  t) {
  ...
  ,
  u.push(o),
  !o.isEnd&&!l&&n+1<t.length&&s.end<i.add(t[n+1].start,
  a))) {
  ...
  function gu(e) {
    for(var t=lt(e.renderRange.start),n=e.renderRange.end,r=[],o=[];
    t<n;
    )r.push(t),
  o.push( {
    start:t,end:tt(t,1);
  ...
  var yu=Bo( {
    optionRefiners: {
    listDayFormat:mu,listDaySideFormat:mu,noEventsClassNames:yn,noEventsContent:yn,noEventsDidMount:yn,noEventsWillUnmount:yn;
  }
  ...
  (To);
    ...
    root:"fc-theme-bootstrap5",tableCellShaded:"fc-theme-bootstrap5-shaded",buttonGroup:"btn-group",button:"btn btn-primary",buttonActive:"active",popover:"popover",popoverHeader:"popover-header",popoverContent:"popover-body";
  }

  ,
  Su.prototype.baseIconClass="bi",
  Su.prototype.iconClasses= {
    close:"bi-x-lg",prev:"bi-chevron-left",next:"bi-chevron-right",prevYear:"bi-chevron-double-left",nextYear:"bi-chevron-double-right";
  }

  ,
  Su.prototype.rtlIconClasses= {
    prev:"bi-chevron-right",next:"bi-chevron-left",prevYear:"bi-chevron-double-right",nextYear:"bi-chevron-double-left";
  }
  ...
  n|| {}
   ...
   {
    key:t,timeMin:a,timeMax:s,singleEvents:!0,maxResults:9999;
  }
  ...
  r) {
    var o,i;
    e.error?n( {
    message:"Google Calendar API:"+e.error.message,errors:e.error.errors,xhr:r;
  }
  ...
  ,
  eventSourceRefiners: {
    googleCalendarApiKey:String,googleCalendarId:String,googleCalendarApiBase:String,extraParams:yn;
  }
  }
  ...
  e.buildHashFromArray=function(e,
  t) {
    for(var n= {}
  ...
  e.filterHash=bt,
  e.findDirectChildren=function(e,
  t) {
    for(var n=e instanceof HTMLElement?[e]:e,r=[],o=0;
    o<n.length;
  ...
  e.formatRange=function(e,
  t,
  n) {
    var r=jr("object"==typeof n&&n?n: {}

  ),o=ln(n),i=r.createMarkerMeta(e),a=r.createMarkerMeta(t);
    return i&&a?r.formatRange(i.marker,
  a.marker,
  o,
   {
    forcedStartTzo:i.forcedTzo,forcedEndTzo:a.forcedTzo,isEndExclusive:n.isEndExclusive,defaultSeparator:cn.defaultRangeSeparator;
  }
  ...
  e.getSegMeta=sr,
  e.getSlotClassNames=function(e,
  t) {
  ...
  e.mapHash=St,
  e.memoize=qt,
  e.memoizeArraylike=function(e,
  t,
  n) {
    var r=this,o=[],i=[];
    return function(a) {
    for(var s=o.length,l=a.length,u=0;
    u<s;
    u+=1)if(a[u]) {
    if(!Gt(o[u],
  a[u])) {
  ...
  ( {}
    ...
    [].push.apply(FullCalendar.globalLocales,
  function() {
    "use strict";
    function e(e) {
  ...
  ,
  buttonText: {
    prev:"Vorige",next:"Volgende",today:"Vandag",year:"Jaar",month:"Maand",week:"Week",day:"Dag",list:"Agenda";
  }

  ,allDayText:"Heeldag",moreLinkText:"Addisionele",noEventsText:"Daar is geen gebeurtenisse nie";
  }
  ...
  direction:"rtl",
  buttonText: {
    prev:"السابق",next:"التالي",today:"اليوم",month:"شهر",week:"أسبوع",day:"يوم",list:"أجندة";
  }

  ,weekText:"أسبوع",allDayText:"اليوم كله",moreLinkText:"أخرى",noEventsText:"أي أحداث لعرض";
  }
  ...
  ,
  buttonText: {
    prev:"Əvvəl",next:"Sonra",today:"Bu Gün",month:"Ay",week:"Həftə",day:"Gün",list:"Gündəm";
  }
  ...
  ,
  buttonText: {
    prev:"назад",next:"напред",today:"днес",month:"Месец",week:"Седмица",day:"Ден",list:"График";
  }
  ...
  ,
  buttonText: {
    prev:"পেছনে",next:"সামনে",today:"আজ",month:"মাস",week:"সপ্তাহ",day:"দিন",list:"তালিকা";
  }
  ...
  ,
  buttonText: {
    prev:"Prošli",next:"Sljedeći",today:"Danas",month:"Mjesec",week:"Sedmica",day:"Dan",list:"Raspored";
  }
  ...
  ,
  buttonText: {
    prev:"Anterior",next:"Següent",today:"Avui",month:"Mes",week:"Setmana",day:"Dia",list:"Agenda";
  }

  ,weekText:"Set",allDayText:"Tot el dia",moreLinkText:"més",noEventsText:"No hi ha esdeveniments per mostrar";
  }
  ...
  ,
  buttonText: {
    prev:"Dříve",next:"Později",today:"Nyní",month:"Měsíc",week:"Týden",day:"Den",list:"Agenda";
  }
  ...
  ,
  buttonText: {
    prev:"Blaenorol",next:"Nesaf",today:"Heddiw",year:"Blwyddyn",month:"Mis",week:"Wythnos",day:"Dydd",list:"Rhestr";
  }

  ,weekText:"Wythnos",allDayText:"Trwy'r dydd",moreLinkText:"Mwy",noEventsText:"Dim digwyddiadau";
  }
  ...
  ,
  buttonText: {
    prev:"Forrige",next:"Næste",today:"I dag",month:"Måned",week:"Uge",day:"Dag",list:"Agenda";
  }

  ,weekText:"Uge",allDayText:"Hele dagen",moreLinkText:"flere",noEventsText:"Ingen arrangementer at vise";
  }
  ...
  ,
  buttonText: {
    prev:"Zurück",next:"Vor",today:"Heute",year:"Jahr",month:"Monat",week:"Woche",day:"Tag",list:"Terminübersicht";
  }
  ...
  ,viewHint:e=>e+("Woche"===e?"n":"Monat"===e?"s":"es")+"ansicht",navLinkHint:"Gehe zu $0",moreLinkHint:e=>"Zeige "+(1===e?"ein weiteres Ereignis":e+" weitere Ereignisse"),closeHint:"Schließen",timeHint:"Uhrzeit",eventHint:"Ereignis";
  }
  ...
  ,
  buttonText: {
    prev:"Προηγούμενος",next:"Επόμενος",today:"Σήμερα",month:"Μήνας",week:"Εβδομάδα",day:"Ημέρα",list:"Ατζέντα";
  }

  ,weekText:"Εβδ",allDayText:"Ολοήμερο",moreLinkText:"περισσότερα",noEventsText:"Δεν υπάρχουν γεγονότα προς εμφάνιση";
  }
  ...
  ,
  buttonHints: {
    prev:"Previous $0",next:"Next $0",today:"This $0";
  }
  ...
  ,
  buttonText: {
    prev:"Antaŭa",next:"Sekva",today:"Hodiaŭ",month:"Monato",week:"Semajno",day:"Tago",list:"Tagordo";
  }

  ,weekText:"Sm",allDayText:"Tuta tago",moreLinkText:"pli",noEventsText:"Neniuj eventoj por montri";
  }
  ...
  ,
  buttonText: {
    prev:"Ant",next:"Sig",today:"Hoy",month:"Mes",week:"Semana",day:"Día",list:"Agenda";
  }
  ...
  ,
  buttonHints: {
    prev:"$0 antes",next:"$0 siguiente",today:e=>"Día"===e?"Hoy":("Semana"===e?"Esta":"Este")+" "+e.toLocaleLowerCase();
  }
  ...
  moreLinkText:"más",
  moreLinkHint:e=>`Mostrar $ {
    e;
  }

  eventos más`,noEventsText:"No hay eventos para mostrar",navLinkHint:"Ir al $0",closeHint:"Cerrar",timeHint:"La hora",eventHint:"Evento";
  }
  ...
  ,
  buttonText: {
    prev:"Eelnev",next:"Järgnev",today:"Täna",month:"Kuu",week:"Nädal",day:"Päev",list:"Päevakord";
  }
  ...
  ,
  buttonText: {
    prev:"Aur",next:"Hur",today:"Gaur",month:"Hilabetea",week:"Astea",day:"Eguna",list:"Agenda";
  }

  ,weekText:"As",allDayText:"Egun osoa",moreLinkText:"gehiago",noEventsText:"Ez dago ekitaldirik erakusteko";
  }
  ...
  direction:"rtl",
  buttonText: {
    prev:"قبلی",next:"بعدی",today:"امروز",month:"ماه",week:"هفته",day:"روز",list:"برنامه";
  }
  ...
  ,
  buttonText: {
    prev:"Edellinen",next:"Seuraava",today:"Tänään",month:"Kuukausi",week:"Viikko",day:"Päivä",list:"Tapahtumat";
  }

  ,weekText:"Vk",allDayText:"Koko päivä",moreLinkText:"lisää",noEventsText:"Ei näytettäviä tapahtumia";
  }
  ...
  ,
   {
    code:"fr",
  buttonText: {
    prev:"Précédent",next:"Suivant",today:"Aujourd'hui",year:"Année",month:"Mois",week:"Semaine",day:"Jour",list:"Mon planning";
  }
  ...
  ,
  buttonText: {
    prev:"Précédent",next:"Suivant",today:"Courant",year:"Année",month:"Mois",week:"Semaine",day:"Jour",list:"Mon planning";
  }
  ...
  ,
  buttonText: {
    prev:"Précédent",next:"Suivant",today:"Aujourd'hui",year:"Année",month:"Mois",week:"Semaine",day:"Jour",list:"Planning";
  }
  ...
  ,
  buttonText: {
    prev:"Ant",next:"Seg",today:"Hoxe",month:"Mes",week:"Semana",day:"Día",list:"Axenda";
  }

  ,weekText:"Sm",allDayText:"Todo o día",moreLinkText:"máis",noEventsText:"Non hai eventos para amosar";
  }
  ...
  direction:"rtl",
  buttonText: {
    prev:"הקודם",next:"הבא",today:"היום",month:"חודש",week:"שבוע",day:"יום",list:"סדר יום";
  }

  ,allDayText:"כל היום",moreLinkText:"אחר",noEventsText:"אין אירועים להצגה",weekText:"שבוע";
  }
  ...
  ,
  buttonText: {
    prev:"पिछला",next:"अगला",today:"आज",month:"महीना",week:"सप्ताह",day:"दिन",list:"कार्यसूची";
  }
  ...
  ,
  buttonText: {
    prev:"Prijašnji",next:"Sljedeći",today:"Danas",month:"Mjesec",week:"Tjedan",day:"Dan",list:"Raspored";
  }
  ...
  ,
  buttonText: {
    prev:"vissza",next:"előre",today:"ma",month:"Hónap",week:"Hét",day:"Nap",list:"Lista";
  }

  ,weekText:"Hét",allDayText:"Egész nap",moreLinkText:"további",noEventsText:"Nincs megjeleníthető esemény";
  }
  ...
  ,
  buttonText: {
    prev:"Նախորդ",next:"Հաջորդ",today:"Այսօր",month:"Ամիս",week:"Շաբաթ",day:"Օր",list:"Օրվա ցուցակ";
  }
  ...
  ,
  buttonText: {
    prev:"mundur",next:"maju",today:"hari ini",month:"Bulan",week:"Minggu",day:"Hari",list:"Agenda";
  }

  ,weekText:"Mg",allDayText:"Sehari penuh",moreLinkText:"lebih",noEventsText:"Tidak ada acara untuk ditampilkan";
  }
  ...
  ,
  buttonText: {
    prev:"Fyrri",next:"Næsti",today:"Í dag",month:"Mánuður",week:"Vika",day:"Dagur",list:"Dagskrá";
  }

  ,weekText:"Vika",allDayText:"Allan daginn",moreLinkText:"meira",noEventsText:"Engir viðburðir til að sýna";
  }
  ...
  ,
  buttonText: {
    prev:"Prec",next:"Succ",today:"Oggi",month:"Mese",week:"Settimana",day:"Giorno",list:"Agenda";
  }
  ...
  ,
   {
    code:"ja",
  buttonText: {
    prev:"前",next:"次",today:"今日",month:"月",week:"週",day:"日",list:"予定リスト";
  }
  ...
  ,
  buttonText: {
    prev:"წინა",next:"შემდეგი",today:"დღეს",month:"თვე",week:"კვირა",day:"დღე",list:"დღის წესრიგი";
  }
  ...
  ,
  buttonText: {
    prev:"Алдыңғы",next:"Келесі",today:"Бүгін",month:"Ай",week:"Апта",day:"Күн",list:"Күн тәртібі";
  }
  ...
  ,
  buttonText: {
    prev:"មុន",next:"បន្ទាប់",today:"ថ្ងៃនេះ",year:"ឆ្នាំ",month:"ខែ",week:"សប្តាហ៍",day:"ថ្ងៃ",list:"បញ្ជី";
  }

  ,weekText:"សប្តាហ៍",allDayText:"ពេញមួយថ្ងៃ",moreLinkText:"ច្រើនទៀត",noEventsText:"គ្មានព្រឹត្តិការណ៍ត្រូវបង្ហាញ";
  }
  ...
  ,
   {
    code:"ko",
  buttonText: {
    prev:"이전달",next:"다음달",today:"오늘",month:"월",week:"주",day:"일",list:"일정목록";
  }

  ,weekText:"주",allDayText:"종일",moreLinkText:"개",noEventsText:"일정이 없습니다";
  }
  ...
  direction:"rtl",
  buttonText: {
    prev:"پێشتر",next:"دواتر",today:"ئەمڕو",month:"مانگ",week:"هەفتە",day:"ڕۆژ",list:"بەرنامە";
  }

  ,weekText:"هەفتە",allDayText:"هەموو ڕۆژەکە",moreLinkText:"زیاتر",noEventsText:"هیچ ڕووداوێك نیە";
  }
  ...
  ,
  buttonText: {
    prev:"Zréck",next:"Weider",today:"Haut",month:"Mount",week:"Woch",day:"Dag",list:"Terminiwwersiicht";
  }

  ,weekText:"W",allDayText:"Ganzen Dag",moreLinkText:"méi",noEventsText:"Nee Evenementer ze affichéieren";
  }
  ...
  ,
  buttonText: {
    prev:"Atgal",next:"Pirmyn",today:"Šiandien",month:"Mėnuo",week:"Savaitė",day:"Diena",list:"Darbotvarkė";
  }

  ,weekText:"SAV",allDayText:"Visą dieną",moreLinkText:"daugiau",noEventsText:"Nėra įvykių rodyti";
  }
  ...
  ,
  buttonText: {
    prev:"Iepr.",next:"Nāk.",today:"Šodien",month:"Mēnesis",week:"Nedēļa",day:"Diena",list:"Dienas kārtība";
  }
  ...
  ,
   {
    code:"mk",
  buttonText: {
    prev:"претходно",next:"следно",today:"Денес",month:"Месец",week:"Недела",day:"Ден",list:"График";
  }
  ...
  ,
  buttonText: {
    prev:"Sebelum",next:"Selepas",today:"hari ini",month:"Bulan",week:"Minggu",day:"Hari",list:"Agenda";
  }
  ...
  ,
  buttonText: {
    prev:"Forrige",next:"Neste",today:"I dag",month:"Måned",week:"Uke",day:"Dag",list:"Agenda";
  }
  ...
  buttonHints: {
    prev:"Forrige $0",next:"Neste $0",today:"Nåværende $0";
  }
  ...
  ,
  buttonText: {
    prev:"अघिल्लो",next:"अर्को",today:"आज",month:"महिना",week:"हप्ता",day:"दिन",list:"सूची";
  }

  ,weekText:"हप्ता",allDayText:"दिनभरि",moreLinkText:"थप लिंक",noEventsText:"देखाउनको लागि कुनै घटनाहरू छैनन्";
  }
  ...
  ,
  buttonText: {
    prev:"Vorige",next:"Volgende",today:"Vandaag",year:"Jaar",month:"Maand",week:"Week",day:"Dag",list:"Agenda";
  }

  ,allDayText:"Hele dag",moreLinkText:"extra",noEventsText:"Geen evenementen om te laten zien";
  }
  ...
  ,
  buttonText: {
    prev:"Førre",next:"Neste",today:"I dag",month:"Månad",week:"Veke",day:"Dag",list:"Agenda";
  }

  ,weekText:"Veke",allDayText:"Heile dagen",moreLinkText:"til",noEventsText:"Ingen hendelser å vise";
  }
  ...
  ,
  buttonText: {
    prev:"Poprzedni",next:"Następny",today:"Dziś",month:"Miesiąc",week:"Tydzień",day:"Dzień",list:"Plan dnia";
  }

  ,weekText:"Tydz",allDayText:"Cały dzień",moreLinkText:"więcej",noEventsText:"Brak wydarzeń do wyświetlenia";
  }
  ...
  ,
   {
    code:"pt-br",
  buttonText: {
    prev:"Anterior",next:"Próximo",today:"Hoje",month:"Mês",week:"Semana",day:"Dia",list:"Lista";
  }
  ...
  ,
  buttonText: {
    prev:"Anterior",next:"Seguinte",today:"Hoje",month:"Mês",week:"Semana",day:"Dia",list:"Agenda";
  }

  ,weekText:"Sem",allDayText:"Todo o dia",moreLinkText:"mais",noEventsText:"Não há eventos para mostrar";
  }
  ...
  ,
  buttonText: {
    prev:"precedentă",next:"următoare",today:"Azi",month:"Lună",week:"Săptămână",day:"Zi",list:"Agendă";
  }
  ...
  ,
  buttonText: {
    prev:"Пред",next:"След",today:"Сегодня",month:"Месяц",week:"Неделя",day:"День",list:"Повестка дня";
  }
  ...
  ,
  buttonText: {
    prev:"පෙර",next:"පසු",today:"අද",month:"මාසය",week:"සතිය",day:"දවස",list:"ලැයිස්තුව";
  }

  ,weekText:"සති",allDayText:"සියලු",moreLinkText:"තවත්",noEventsText:"මුකුත් නැත";
  }
  ...
  ,
  buttonText: {
    prev:"Predchádzajúci",next:"Nasledujúci",today:"Dnes",month:"Mesiac",week:"Týždeň",day:"Deň",list:"Rozvrh";
  }
  ...
  ,
  buttonText: {
    prev:"Prejšnji",next:"Naslednji",today:"Trenutni",month:"Mesec",week:"Teden",day:"Dan",list:"Dnevni red";
  }

  ,weekText:"Teden",allDayText:"Ves dan",moreLinkText:"več",noEventsText:"Ni dogodkov za prikaz";
  }
  ...
  ,
   {
    code:"sm",
  buttonText: {
    prev:"Talu ai",next:"Mulimuli atu",today:"Aso nei",month:"Masina",week:"Vaiaso",day:"Aso",list:"Faasologa";
  }

  ,weekText:"Vaiaso",allDayText:"Aso atoa",moreLinkText:"sili atu",noEventsText:"Leai ni mea na tutupu";
  }
  ...
  ,
  buttonText: {
    prev:"mbrapa",next:"Përpara",today:"sot",month:"Muaj",week:"Javë",day:"Ditë",list:"Listë";
  }
  ...
  ,
  buttonText: {
    prev:"Претходна",next:"следећи",today:"Данас",month:"Месец",week:"Недеља",day:"Дан",list:"Планер";
  }
  ...
  ,
  buttonText: {
    prev:"Prethodna",next:"Sledeći",today:"Danas",month:"Mеsеc",week:"Nеdеlja",day:"Dan",list:"Planеr";
  }
  ...
  ,
  buttonText: {
    prev:"Förra",next:"Nästa",today:"Idag",month:"Månad",week:"Vecka",day:"Dag",list:"Program";
  }
  ...
  moreLinkHint:e=>`Visa ytterligare $ {
    e;
  }
  ...
  `,weekText:"v.",weekTextLong:"Vecka",allDayText:"Heldag",moreLinkText:"till",noEventsText:"Inga händelser att visa",closeHint:"Stäng",timeHint:"Klockan",eventHint:"Händelse";
  }
  ...
  ,
  buttonText: {
    prev:"முந்தைய",next:"அடுத்தது",today:"இன்று",month:"மாதம்",week:"வாரம்",day:"நாள்",list:"தினசரி அட்டவணை";
  }
  ...
  ,
  buttonText: {
    prev:"ก่อนหน้า",next:"ถัดไป",prevYear:"ปีก่อนหน้า",nextYear:"ปีถัดไป",year:"ปี",today:"วันนี้",month:"เดือน",week:"สัปดาห์",day:"วัน",list:"กำหนดการ";
  }

  ,weekText:"สัปดาห์",allDayText:"ตลอดวัน",moreLinkText:"เพิ่มเติม",noEventsText:"ไม่มีกิจกรรมที่จะแสดง";
  }
  ...
  ,
  buttonText: {
    prev:"geri",next:"ileri",today:"bugün",month:"Ay",week:"Hafta",day:"Gün",list:"Ajanda";
  }

  ,weekText:"Hf",allDayText:"Tüm gün",moreLinkText:"daha fazla",noEventsText:"Gösterilecek etkinlik yok";
  }
  ...
  ,
   {
    code:"ug",
  buttonText: {
    month:"ئاي",week:"ھەپتە",day:"كۈن",list:"كۈنتەرتىپ";
  }
  ...
  ,
  buttonText: {
    prev:"Попередній",next:"далі",today:"Сьогодні",month:"Місяць",week:"Тиждень",day:"День",list:"Порядок денний";
  }
  ...
  ,
   {
    code:"uz",
  buttonText: {
    month:"Oy",week:"Xafta",day:"Kun",list:"Kun tartibi";
  }
  ...
  ,
  buttonText: {
    prev:"Trước",next:"Tiếp",today:"Hôm nay",month:"Tháng",week:"Tuần",day:"Ngày",list:"Lịch biểu";
  }
  ...
  ,
  buttonText: {
    prev:"上月",next:"下月",today:"今天",month:"月",week:"周",day:"日",list:"日程";
  }
  ...
  ,
   {
    code:"zh-tw",
  buttonText: {
    prev:"上月",next:"下月",today:"今天",month:"月",week:"週",day:"天",list:"活動列表";
  }

  ,weekText:"周",allDayText:"整天",moreLinkText:"顯示更多",noEventsText:"没有任何活動";
  }
